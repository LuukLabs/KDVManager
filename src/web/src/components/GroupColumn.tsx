import { Box, Paper, Typography, CircularProgress, useTheme, useMediaQuery, Chip } from "@mui/material";
      ...
      {isLoading ? (
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: { xs: 1, md: 1.5 }, flex: 1 }}>
          {schedules && schedules.length > 0 ? (
            ...
            >
              <Box>
                <EventBusyIcon sx={{ fontSize: { xs: 40, md: 48 }, color: 'text.secondary', mb: 1 }} />

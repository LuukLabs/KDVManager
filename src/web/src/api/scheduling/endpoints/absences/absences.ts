...
export const deleteAbsence = (id: string) => {
  return executeFetch<null>({ url: `/scheduling/v1/absences/${id}`, method: "DELETE" });
};
...
export type DeleteAbsenceMutationError = ProblemDetails | ProblemDetails;

export const useDeleteAbsence = <TError = ProblemDetails | ProblemDetails, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteAbsence>>,
      TError,

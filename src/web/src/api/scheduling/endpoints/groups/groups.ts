...
export const deleteGroup = (id: string) => {
  return executeFetch<null>({ url: `/scheduling/v1/groups/${id}`, method: "DELETE" });
};
...
export type DeleteGroupMutationError = ProblemDetails | ProblemDetails;

export const useDeleteGroup = <TError = ProblemDetails | ProblemDetails, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteGroup>>,
      TError,

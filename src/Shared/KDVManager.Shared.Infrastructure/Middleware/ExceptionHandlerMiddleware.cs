...
public class ExceptionHandlerMiddleware
{
    ...
    public ExceptionHandlerMiddleware(RequestDelegate next, ILogger<ExceptionHandlerMiddleware> logger, ApiMetrics metrics)
    {
        _next = next;
        _logger = logger;
        _metrics = metrics;
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        catch (Exception exception)
        {
            ...
            _metrics.ErrorCounter.Add(1,
                ...
                new KeyValuePair<string, object?>("service", _metrics.ServiceName));

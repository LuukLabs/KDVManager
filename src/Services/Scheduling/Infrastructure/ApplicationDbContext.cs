...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<AgeBasedWorkflowRule> AgeBasedWorkflowRules { get; set; }
    ...
    modelBuilder.Entity<AgeBasedWorkflowRule>().HasQueryFilter(a => a.TenantId == _tenancyContextAccessor.Current!.TenantId);

...
export const deleteTimeSlot = (id: string) => {
  return executeFetch<null>({ url: `/scheduling/v1/timeslots/${id}`, method: "DELETE" });
};
...
export type DeleteTimeSlotMutationError = ProblemDetails | ProblemDetails;

export const useDeleteTimeSlot = <TError = ProblemDetails | ProblemDetails, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteTimeSlot>>,
      TError,

...
namespace KDVManager.Services.PlatformManagement.Api.Middleware;
...
public class ExceptionHandlerMiddleware
{
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        catch (Exception exception)
        {
            ...
            PlatformManagementApiMetrics.ErrorCounter.Add(1,
                new KeyValuePair<string, object?>("error_type", exception.GetType().Name),
                new KeyValuePair<string, object?>("service", "platformmanagement-api"));
    ...
    private Task ConvertException(HttpContext context, Exception exception)
    {
        ...
        {
            TraceId = traceId,
            Service = "platformmanagement-api",

...
/// <summary>
/// Read-model trial status for the CRM service. The trial start date is synced
/// from the TenantManagement service (source of truth) via <c>TenantRegisteredEvent</c>.

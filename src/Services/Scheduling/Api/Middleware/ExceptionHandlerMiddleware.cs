...
public class ExceptionHandlerMiddleware
{
    ...
    public async Task Invoke(HttpContext context)
    {
        ...
        catch (Exception exception)
        {
            ...
            SchedulingApiMetrics.ErrorCounter.Add(1,
                new KeyValuePair<string, object?>("error_type", exception.GetType().Name),
                new KeyValuePair<string, object?>("service", "scheduling-api"));
    ...
    private Task ConvertException(HttpContext context, Exception exception)
    {
        ...
        switch (exception)
        {
            ...
            case ConflictException conflictException:
                ...
                _logger.LogWarning(exception,
                    "Conflict exception in {Service} at {RequestPath}. TraceId: {TraceId}",
                    errorDetails.Service,
                    errorDetails.RequestPath,
                    errorDetails.TraceId);
                break;

...
```tsx
<FieldDisplay label="First Name" value={firstName} loading={loading} placeholder="Not specified" />
```
...
<BasicInformationCard firstName="John" lastName="Doe" dateOfBirth="2020-01-15" isEditing={false} />;
```

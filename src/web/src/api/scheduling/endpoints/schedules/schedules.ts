...
import type { UpdateScheduleCommand } from "../../models/updateScheduleCommand";
...
export const getGetPrintSchedulesUrl = (params?: GetPrintSchedulesParams) => {
  ...
  Object.entries(params || {}).forEach(([key, value]) => {
    const explodeParameters = ["groupIds"];
...
export const updateSchedule = async (
  ...
  return executeFetch<string>(getUpdateScheduleUrl(id), {
    ...options,
    method: "PUT",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(updateScheduleCommand),
  });
};
...
>(options?: {
  mutation?: UseMutationOptions<
    ...
    TError,
    { id: string; data: UpdateScheduleCommand },
    TContext
  >;
  request?: SecondParameter<typeof executeFetch>;
}): UseMutationOptions<
...
export type UpdateScheduleMutationBody = UpdateScheduleCommand;
export type UpdateScheduleMutationError = ProblemDetails | UnprocessableEntityResponse;

...
namespace KDVManager.Services.CRM.Infrastructure.Migrations
{
    ...
    [Migration("20260706002455_AddAdministrators")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KDVManager.Services.CRM.Domain.Entities.Administrator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KDVManager.Services.CRM.Domain.Entities.Child", b =>
                {
                    ...
                    b.HasIndex("TenantId", "ChildNumber")
                        .IsUnique();
            ...
            modelBuilder.Entity("KDVManager.Services.CRM.Domain.Entities.ChildActivityInterval", b =>
                {
                    ...
                    b.ToTable("ChildActivityIntervals");
                });
            ...
            modelBuilder.Entity("KDVManager.Services.CRM.Domain.Entities.ChildNumberSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("NextChildNumber")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ChildNumberSequences");
                });
